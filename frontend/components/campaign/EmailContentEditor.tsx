...
import IntegratedBuilder from '@/components/IntegratedBuilder'
...
export default function EmailContentEditor({ campaignId, onNext, onBack }: EmailContentEditorProps) {
  ...
  useEffect(() => {
    // If we have blocks, default to visual mode
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
        <Tabs value={editorMode} onValueChange={(v) => setEditorMode(v as 'visual' | 'classic')} className="w-full md:w-[400px]">
